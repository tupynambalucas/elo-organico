# Docker Hub MCP Context - Elo Orgânico

This file provides rules and security compliance references for container registry interactions within the **Elo Orgânico** infrastructure.
