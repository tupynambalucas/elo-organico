...
- [compose.yaml](./compose.yaml): Service definitions, environment mapping, and volume configurations.
- [AGENTS.md](./AGENTS.md): Authoritative context rules loaded by the agent's brain.
- [mcp_config.json](./mcp_config.json): Endpoint registry pointing to the internal MCP gateway.
...
- `skills/`: Shared specialized markdown skills ([code-expert](../../.agents/skills/code-expert/SKILL.md) and [doc-expert](../../.agents/skills/doc-expert/SKILL.md)) mounted into the containers.
