...
This document defines the formatting, structural patterns, and content conventions for general Markdown files (`.md`, `README.md`, and skill documentation) across the **Elo Orgânico** monorepo.
