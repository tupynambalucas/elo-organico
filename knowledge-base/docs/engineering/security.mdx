...
The following security keys are mandatory for the **Instance** stack to operate:

| Environment | Variable | Purpose |
| :--- | :--- | :--- |
| **API** | `TURNSTILE_SECRET_KEY` | Server-side validation of Turnstile tokens. |
| **Web** | `VITE_TURNSTILE_SITE_KEY` | Rendering the Turnstile widget on the frontend. |
| **API** | `JWT_SECRET` | Signing authentication tokens. |
| **API** | `SESSION_SECRET` | Encrypting session cookies. |
