...
| :--- | :--- | :--- |
| `pnpm instance:prod` | Production | Builds and starts Instance stack (API + Web + Redis) using `.env.prod` |
| `pnpm instance:staging` | Staging | Same stack, uses `.env.staging` (different Atlas cluster and secrets) |
| `pnpm instance:prod:down` | Prod/Staging | Stops the Instance production stack |
| `pnpm portal:prod` | Production | Builds and starts Portal stack using `.env.prod` |
| `pnpm portal:staging` | Staging | Same stack, uses `.env.staging` |
| `pnpm portal:prod:down` | Prod/Staging | Stops the Portal production stack |
...
**Production flow:**
```
pnpm instance:prod  →  compose.prod.yaml builds and starts:
