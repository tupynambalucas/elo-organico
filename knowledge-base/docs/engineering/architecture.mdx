...
| :--- | :--- | :--- | :--- |
| `[context]/.env.dev` | `compose.yaml` | Dev infrastructure environment and DB initialization variables (MongoDB/Redis) | ignored |
...
*Note: In the table above, `[context]` represents either the `instance` or `portal` directory.*
