...
| knowledge-base/        | @elo-organico/docs   | **Docs Hub**  | Hub oficial de documentação do projeto e landing page técnica. |
...
- **Implantação (Deployment)**:
  ...
  - **Base de Conhecimento**: O **hub oficial do projeto** para documentação (EloDocs) e especificações técnicas.
