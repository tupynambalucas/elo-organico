...
### Contexto de Knowledge Base (knowledge-base/)

O hub de documentação do desenvolvedor (EloDocs). Para documentação detalhada, consulte o **[Workspace Knowledge Base](/workspaces/knowledge-base)**.
...
3.  **Executar Ambiente de Desenvolvimento:**
    ...
    Consulte a **[Referência de Orquestração](./contributing/orchestration.mdx)** para uma lista completa de comandos.
