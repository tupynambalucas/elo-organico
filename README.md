...
While architected for a future Multi-tenant SaaS model, our current priority is the perfect delivery of a standalone community instance (instance/_). All SaaS features in the portal-_ scope are foundation-only at this stage.
