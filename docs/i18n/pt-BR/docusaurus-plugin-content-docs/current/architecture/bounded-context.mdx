...
| instance/services/api  | @elo-instance/api   | **Instância** | API REST Fastify para uma instância de comunidade específica.        |
| instance/services/web  | @elo-instance/web   | **Instância** | React SPA (Admin/Loja) para uma instância de comunidade específica.  |
