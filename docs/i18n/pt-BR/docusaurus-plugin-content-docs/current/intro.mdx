...
4.  **Executar Ambiente de Desenvolvimento:**
    ...
    Consulte a **[Referência de Orquestração](./architecture/infra-orchestration-deploy/orchestration.mdx)** para uma lista completa de comandos, incluindo comandos de implantação em produção.
...
- **[Visão Geral da Arquitetura](./architecture/overview.mdx)**: Stack técnica e estratégia de monorepo.
