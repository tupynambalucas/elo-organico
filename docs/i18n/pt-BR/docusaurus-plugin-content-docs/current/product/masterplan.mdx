...
Todas as decisões arquiteturais, estrutura do projeto e detalhes da stack tecnológica estão centralizados na **[Visão Geral da Arquitetura](../architecture/overview.mdx)**.
