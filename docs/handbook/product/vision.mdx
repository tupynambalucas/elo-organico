...
1.  **Platform Scope (@elo-portal/web & @elo-portal/api)**: The future global product hub and SaaS entry point. This is a standalone singleton layer that will handle high-level discovery and onboarding (currently in foundation stage).
...
## 6. The Product Journey (User Experience)
